...
{
	world->EnqueueEntitySpawn(TransformData {}, CarFollowCameraData { car, Vector3(10.0f, 5.50f, 0.0f), Quaternion::Euler(-12.0f, 0, 0) }, CameraData { 60.0f, true, 0.1f, 10000.0f });
}
